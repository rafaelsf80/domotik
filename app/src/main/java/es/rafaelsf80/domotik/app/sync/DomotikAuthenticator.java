...
/**
 * Manages "Authentication" to Weather backend service.  The SyncAdapter framework
 ...
 */
public class DomotikAuthenticator extends AbstractAccountAuthenticator {

    public DomotikAuthenticator(Context context) {
        super(context);
    }
