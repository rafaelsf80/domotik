...
public class DomotikSyncService extends Service {
    private final String TAG = getClass().getSimpleName();

    private static final Object sSyncAdapterLock = new Object();
    private static DomotikSyncAdapter sDomotikSyncAdapter = null;
    ...
    public IBinder onBind(Intent intent) {
        return sDomotikSyncAdapter.getSyncAdapterBinder();
    }
}